<x-app-layout>
    <div class="w-full space-y-6">
            ...
            <div class="flex min-h-[210px] flex-col gap-8 px-6 py-8 sm:px-8 sm:py-10 lg:flex-row lg:items-center lg:justify-between lg:px-10 lg:py-11">
                <div class="min-w-0">
                    ...
                    <p class="mt-4 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
                        Catat hasil evaluasi rapat, kegiatan, target, temuan,
                        rekomendasi, serta tautan rekaman pendukung Unit SIM TI.
                    </p>
                    ...
                    <div class="mt-5 flex flex-wrap gap-2">
                        ...
                        <span class="inline-flex items-center rounded-full bg-white/10 px-3 py-1.5 text-xs font-semibold text-slate-100 ring-1 ring-inset ring-white/15">
                            Dokumen pendukung ditambahkan dari halaman detail
                        </span>
                    </div>
                </div>
        ...
        <form
            method="POST"
            action="{{ route('documentation.evaluasi.store') }}"
            class="space-y-6"
        >
            @csrf
                ...
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Tentukan unit, judul, jenis, tanggal, dan sumber evaluasi.
                        </p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            >
                                ...
                                @foreach ($units as $unit)
                                    <option
                                        value="{{ $unit->id }}"
                                        @selected((string) old('unit_id') === (string) $unit->id)
                                    >
                                        {{ $unit->name }}
                                    </option>
                                @endforeach
                    ...
                    <div>
                        ...
                        >
                            @foreach ($typeOptions as $value => $label)
                                <option
                                    value="{{ $value }}"
                                    @selected(old('evaluation_type', 'other') === $value)
                                >
                                    {{ $label }}
                                </option>
                            @endforeach
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('evaluation_date', now()->toDateString()) }}"
                            class="mt-2 block w-full rounded-xl border-slate-300 bg-white py-2.5 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:ring-sky-500"
                        >
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Tambahkan tautan Zoom atau Google Drive bila tersedia.
                        </p>
                    </div>
                </div>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Catat temuan, kendala, kesimpulan, dan rekomendasi tindak lanjut.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h2 class="text-sm font-semibold text-sky-900">
                            Dokumen pendukung ditambahkan setelah evaluasi dibuat
                        </h2>

                        <p class="mt-1 text-sm leading-6 text-sky-700">
                            Setelah Draft tersimpan, anda akan diarahkan kembali ke daftar.
                            Dokumen notulen, berita acara, gambar, dan file pendukung
                            dapat ditambahkan melalui halaman detail evaluasi.
                        </p>
                    </div>
                </div>
            </section>
