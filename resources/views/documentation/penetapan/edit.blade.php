<x-app-layout>
    <div class="w-full space-y-6">
            ...
            <div class="flex min-h-[210px] flex-col gap-8 px-6 py-8 sm:px-8 sm:py-10 lg:flex-row lg:items-center lg:justify-between lg:px-10 lg:py-11">
                <div class="min-w-0">
                    ...
                    <h1 class="mt-5 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                        Edit Dokumen Penetapan
                    </h1>

                    <p class="mt-4 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
                        Perbarui informasi, metadata, dan file dokumen Penetapan selama dokumen masih berstatus Draft.
                    </p>
        ...
        <form
            method="POST"
            action="{{ route('documentation.penetapan.update', $document) }}"
                ...
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Perbarui kategori, judul, dan deskripsi dokumen.
                        </p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach ($categories as $value => $label)
                                <option
                                    value="{{ $value }}"
                                    @selected(old('category', $document->category) === $value)
                                >
                                    {{ $label }}
                                </option>
                            @endforeach
                        ...
                        <p class="mt-2 text-xs leading-5 text-slate-500">
                            Perubahan kategori akan memindahkan dokumen ke submenu terkait.
                        </p>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Perbarui nomor, revisi, serta tanggal dokumen.
                        </p>
                    </div>
                </div>
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-slate-500">
                            Lihat file saat ini atau unggah file pengganti.
                        </p>
                    </div>
                </div>

                @if ($document->file_path)
                    <div class="mb-5 rounded-2xl border border-sky-200 bg-sky-50 p-5">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div class="flex min-w-0 items-start gap-3">
                                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white text-sky-700 ring-1 ring-inset ring-sky-200">
                                    <x-icon name="file-text" class="h-5 w-5" />
                                </div>
                            ...
                            <a
                                ...
                                class="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-sky-200 bg-white px-4 py-2.5 text-sm font-semibold text-sky-700 shadow-sm transition hover:bg-sky-100"
                            >
                ...
                <div class="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-5">
                    ...
                    <p class="mt-3 text-xs leading-5 text-slate-500">
                        Kosongkan jika file tidak ingin diganti. Format PDF, Word, Excel,
                        PowerPoint, JPG, atau PNG. Ukuran maksimal 10 MB.
                    </p>
