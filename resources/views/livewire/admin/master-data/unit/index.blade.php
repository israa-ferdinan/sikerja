<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-gray-800">Master Data Unit</h1>
            <p class="text-sm text-gray-500">
                Kelola data unit kerja sebagai referensi pegawai dan laporan kerja harian.
            </p>
        </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 text-left text-gray-600">
                            ...
                            <th class="border-b px-3 py-3">Kode Unit</th>
                            <th class="border-b px-3 py-3">Nama Unit</th>
